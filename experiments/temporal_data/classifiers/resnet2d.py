...
class Classifier_RESNET2D:
    ...
    def build_model(self, input_shape, nb_classes):
        ...
        conv_x = keras.layers.Conv2D(filters=n_feature_maps, kernel_size=(7, 7), padding='same')(input_layer)
        conv_x = keras.layers.BatchNormalization()(conv_x)
        conv_x = keras.layers.Activation('relu')(conv_x)

        conv_y = keras.layers.Conv2D(filters=n_feature_maps, kernel_size=(5, 5), padding='same')(conv_x)
        conv_y = keras.layers.BatchNormalization()(conv_y)
        conv_y = keras.layers.Activation('relu')(conv_y)

        conv_z = keras.layers.Conv2D(filters=n_feature_maps, kernel_size=(3, 3), padding='same')(conv_y)
        ...
        conv_x = keras.layers.Conv2D(filters=n_feature_maps * 2, kernel_size=(7, 7), padding='same')(output_block_1)
        conv_x = keras.layers.BatchNormalization()(conv_x)
        conv_x = keras.layers.Activation('relu')(conv_x)

        conv_y = keras.layers.Conv2D(filters=n_feature_maps * 2, kernel_size=(5, 5), padding='same')(conv_x)
        conv_y = keras.layers.BatchNormalization()(conv_y)
        conv_y = keras.layers.Activation('relu')(conv_y)

        conv_z = keras.layers.Conv2D(filters=n_feature_maps * 2, kernel_size=(3, 3), padding='same')(conv_y)
        conv_z = keras.layers.BatchNormalization()(conv_z)
        ...
        conv_x = keras.layers.Conv2D(filters=n_feature_maps * 2, kernel_size=(7 ,7), padding='same')(output_block_2)
        conv_x = keras.layers.BatchNormalization()(conv_x)
        conv_x = keras.layers.Activation('relu')(conv_x)
